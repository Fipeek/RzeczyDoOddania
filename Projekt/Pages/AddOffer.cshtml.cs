...
namespace Projekt.Pages.AddOffer
{
    ...
    public class AddOfferModel : PageModel
    {
        ...
        public AddOfferModel(IOfferService offerService, UserManager<User> userManager,IUserService userService, IHostEnvironment hostEnvironment, ICategoriesService categroiesService, ICategoryGroupService categoryGroupService)
        {
